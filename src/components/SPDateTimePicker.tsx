...
export class SPDateTimePicker extends React.Component<ISPDateTimePickerProps, ISPDateTimePickerState> {
    ...
    constructor(props: ISPDateTimePickerProps) {
        ...
        this.state = {
            date: (this.props.initialDateTime != null) ? new Date(this.props.initialDateTime.toString()) : null,
            hours: (this.props.initialDateTime != null) ? new Date(this.props.initialDateTime.toString()).getHours() : 0,
            minutes: (this.props.initialDateTime != null) ? new Date(this.props.initialDateTime.toString()).getMinutes() : 0,
            seconds: (this.props.initialDateTime != null) ? new Date(this.props.initialDateTime.toString()).getSeconds() : 0,
        };
    }
  ...
  private _minutesChanged(newValue: string) : void {
    ...
    this.setState({minutes:Number(newValue)});
    this.saveFullDate();
  }
  ...
  private _secondsChanged(newValue: string) : void {
    ...
    this.setState({seconds:Number(newValue)});
    this.saveFullDate();
  }
  ...
  private saveFullDate(): void {
   ...
   // this.state.fullDate = finalDateAsString;
    this.setState({fullDate:finalDateAsString});
